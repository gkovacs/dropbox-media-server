...
(function(){
  var root, express, dbox, htmlspecialchars, jsYaml, app, basicAuth, passwords, mongo, MongoClient, mongourl, ref$, getMongoDb, getDropboxmediaCollection, getAccessTokenMongo, saveAccessTokenMongo, getAppKeySecretMongo, saveAppKeySecretMongo, get_app_key_secret, get_access_token, getdapp, getclient, sendhtml;
